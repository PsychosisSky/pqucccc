...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pqucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pqucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pqucoin transaction") + "\n" +
              "  pqucoin-tx [options] -create [commands]   " + _("Create hex-encoded pqucoin transaction") + "\n" +
              "\n";
