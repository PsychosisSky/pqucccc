# Contributing to Pqucoin Core

Pqucoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/pqucoin/pqucoin/labels/help%20wanted)
* [Projects](https://github.com/pqucoin/pqucoin/projects)
* [Pqucoindev on reddit](https://www.reddit.com/r/pqucoindev/)

## Branch Strategy

Pqucoin Core's default branch is intentionally a stable release, so that anyone
...
Pqucoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Pqucoin Core
releases will automatically benefit from these.

When refactoring Pqucoin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Pqucoin Core, and is not to be
confused with overall Pqucoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Pqucoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Pqucoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Pqucoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Pqucoin consensus, it must have been
