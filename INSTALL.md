# Installing Pqucoin Core

### Pre-compiled binaries

The easiest way to install the latest version of the Pqucoin Core software is
by to download the latest precompiled binaries for your platform from the
[release page](https://github.com/pqucoin/pqucoin/releases). Currently,
...
It is possible to build your own copy of Pqucoin Core with the exact, tested,
dependencies, as used for the binary releases, by using the
[depends system](depends/description.md). Please refer to the
[depends README](depends/README.md) for instructions to build Pqucoin using
these dependencies.

### Compiling using system-provided libraries

  The following are developer notes on how to build Pqucoin on your native
  ...
  - [macOS Build Notes](doc/Building-Pqucoin-1.14-for-Mac.md)
...
Run with the `-testnet` option to run with "play pqucoins" on the test network, if you
...
Pqucoin Core is a multithreaded application, and deadlocks or other multithreading bugs
