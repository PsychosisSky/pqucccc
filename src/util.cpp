...
const char * const BITCOIN_CONF_FILENAME = "pqucoin.conf";
const char * const BITCOIN_PID_FILENAME = "pqucoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pqucoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pqucoin";
#else
    // Unix
    return pathRet / ".pqucoin";
#endif
#endif
}
