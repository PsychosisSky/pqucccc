...
/** Recommended transaction fee by Pqucoin Core developers
  *
 ...
 *
 *  Pqucoin:    Increment mempool limits and accept RBF in steps of 0.0001 PQU
...
/**
 * Pqucoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Pqucoin: Default hard dust limit that is evaluated when considering whether
