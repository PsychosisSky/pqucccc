...
{
    const char* pszTimestamp = "pquc nb";
    const CScript genesisOutputScript = CScript() << ParseHex("04559de39b3a93552d9d2552d1121c0f51dfa46880b9077377c19ce99023abfeb61f9cf682523528898f2a84aab5a46043152774a109a77b81aac8f667f008b9f9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        //wh_difficuly
        consensus.nPowTargetTimespan = 4 * 10; // pre-digishield: 4 hours
